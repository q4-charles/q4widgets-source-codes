(function ($) {
    ...
    $.widget('q4.api', /** @lends q4.api */ {
        options: {
             ...
             *   <li><a href="q4.presentations.html#option-template">Presentations</a></li>
             *   <li><a href="q4.news.html#option-template">News</a></li>
             *   <li><a href="q4.sec.html#option-template">SEC</a></li>
             * </ul>
             * <br>
             * <pre>
             * template: (
     ...
     * @extends q4.api
     * @desc
     * This widget fetches and displays downloads (also known as "Content Assets") from the Q4 API's.<br>
     * <hr>
     * Below is an example of a download list widget. <br>
     * - It uses the <code>template</code> option as there is no need for a year/item separation or filter in this example.<br>
     * - Since it is a past events widget, <code>showFuture</code> is set to <code>false</code>.<br>
     * - The template will loop through each year, and each item inside that year and render the values of the variabels within.<br>
     * <hr>
     * @example
    ...
    $.widget('q4.downloads', $.q4.api, /** @lends q4.downloads */ {
        options: {
             ...
             * <ul>
             *   <li>All the notes documented in the <a href="q4.api.html#option-template">q4.api</a> parent widget are applicable here.</li>
             ...
             * <ul>
             *   <li><code>{{title}}</code> - The title of the download item.</li>
             *   <li><code>{{description}}</code> - The download description.</li>
             *   <li><code>{{url}}</code> - The URL of the document.</li>
             *   <li><code>{{date}}</code> - The date of the download.</li>
             *   <li><code>{{type}}</code> - The download list category (ex. Governance Documents, Factsheets).</li>
             *   <li><code>{{fileType}}</code> - The file type.</li>
             *   <li><code>{{size}}</code> - The file size.</li>
             *   <li><code>{{icon}}</code> - The URL of the document's icon.</li>
             *   <li><code>{{thumb}}</code> - The URL of the document's thumbnail image.</li>
             *   <li><code>{{#tags}}</code> - An array of tags for this download item.
             *      <ul>
     ...
     * <hr>
     * Below is an example of a past events widget. <br>
     * - It uses date and time, which requires the <code>useMoment</code> option to be <code>true</code> and the Moment.js library to be referenced on the page.<br>
     * - Since it is a past events widget, <code>showFuture</code> is set to <code>false</code>.<br>
     * - Events can pull in "related" content from the following API's: Presentations, Press Releases and Financial Reports. Template variables for related content are inherited from their respective widget.
     * For example, one can use press releases <code>shortBody</code> variable in the events widget template for related press releases.<br>
     * - Based on the template configuration, the widget will only show related files such as presentations or webcasts if they exist for that event.<br>
     * <hr>
     * @example
     * <div class="module_container module_container--widget">
    ...
    $.widget('q4.events', $.q4.api, /** @lends q4.events */ {
        options: {
             ...
             * The <code>template</code> or <code>itemTemplate</code> may contain the following mustache variables:
             * <ul>
             *   <li><code>{{title}}</code> - The title of the event item.</li>
             *   <li><code>{{url}}</code> - The URL of the event details page.</li>
             *   <li><code>{{id}}</code> - The event ID, used for constructing calendar links.</li>
             ...
             *   <li><code>{{location}}</code> - The URL of the document's thumbnail image.</li>
             *   <li><code>{{webcast}}</code> - </li>
             *   <li><code>{{body}}</code> - </li>
             *   <li><code>{{#isFuture}}</code> - An alternative to the showFuture widget option. Using this in the template will allow you to
             *     define a unique template events in the future, without affecting other events in the array. To use, wrap {{#isFuture}} around other template variables and close with {{/isFuture}}</li>
             *   <li><code>{{#isPast}}</code> - An alternative to the showPast widget option. Using this in the template will allow you to
             *     define a unique template events in the past, without affecting other events in the array. To use, wrap {{#isPast}} around other template variables and close with {{/isPast}}</li>
             *   <li><code>{{#speakers}}</code> - An array of the event's speakers. Inner variables are:
             *      <ul>
             *        <li><code>{{name}}</code> - The speaker's name.</li>
             *        <li><code>{{position}}</code> - The speaker's position or job title.</li>
             *      </ul>
             *    </li>
             *   <li><code>{{#tags}}</code> - An array of tags for this event item.
             *      <ul>
             *        <li><code>{{.}}</code> -  Tag word.</li>
             *      </ul>
             *   </li>
             ...
             *        <li><code>{{type}}</code> - The type/category of attachment (ex. Document, Presentation, Video, Audio)</li>
             *        <li><code>{{extension}}</code> - The file extension for the attachment</li>
             *        <li><code>{{size}}</code> - The speaker's position or job title.</li>
             *      </ul>
             *   </li>
             *   <li><code>{{#financialReports}}</code> - An array of related financial reports.
             *      <ul>
             *        <li>See the <a href="q4.financials.html#option-template">financial reports widget page</a> for a full list of available template options.</li>
             *      </ul>
             *   </li>
             *   <li><code>{{#pressReleases}}</code> - An array of related press releases.
             *      <ul>
             *         <li>See the <a href="q4.news.html#option-template">news widget page</a> for a full list of available template options.</li>
             *      </ul>
             *   </li>
             *   <li><code>{{#presentations}}</code> - An array of related presentations.</li>
             *      <ul>
             *         <li>See the <a href="q4.presentations.html#option-template">presentations widget page</a> for a full list of available template options.</li>
             *      </ul>
             *   </li>
             * </ul>
             * @type {string}
